                ...
                <form class="text-center " method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="file" name="musicvideoItem" value="{{old('musicvideoItem',isset($musicVideoItem) ? $musicVideoItem->musicvideoItem : '')}}">
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="file" name="musicvideoposter" value="{{old('musicvideoposter',isset($musicVideoItem) ? $musicVideoItem->musicvideoposter : '')}}">
                            </div>
                        </div>
